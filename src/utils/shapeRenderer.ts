...
export function getShapeClipPath(shape: EmbeddingShape): string {
  const shapes: Record<EmbeddingShape, string> = {
    ...
    cross:
      'polygon(35% 0%, 65% 0%, 65% 35%, 100% 35%, 100% 55%, 65% 55%, 65% 100%, 35% 100%, 35% 55%, 0% 55%, 0% 35%, 35% 35%)',
    x:
      'polygon(0% 0%, 30% 0%, 50% 20%, 70% 0%, 100% 0%, 80% 30%, 100% 50%, 80% 70%, 100% 100%, 70% 100%, 50% 80%, 30% 100%, 0% 100%, 20% 70%, 0% 50%, 20% 30%)',
    plus:
